/** TODO:
 * pegar valor pelo input do formulario X
 * pegar valor da quantidade x
 * diminuir do valor total da opção (pista, cadeira superior, cadeira inferior)
 * se uma opção de pista estiver zerada, não permitir adicionar mais via alert
 */
